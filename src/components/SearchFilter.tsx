      ...
      <SafeAreaView>
        <View style={styles.container}>
          ...
          <View style={[styles.inputUpperParent, {}]}>
            ...
            <View
              style={[styles.inputParent, {width: rh(7), marginLeft: rw(2)}]}>
              <TouchableOpacity
                style={{}}
                testID='add_to_search_history'
                onPress={() => {
          ...
          <View style={styles.historyParent}>
            {history.map((item: string, index: number) => (
              <View style={styles.historyParentInner} key={index}>
                <TouchableOpacity style={styles.history} key={index}>
                  <Text style={styles.historytitle}>{item}</Text>
                </TouchableOpacity>
                <TouchableOpacity
                testID={'remove'+index}
                  onPress={() => this.props.removeFromSearchHistory(index)}>
          ...
          <View style={{marginTop: rh(2)}}>
            ...
            <View
              ...
              <View>
                ...
                <Text style={[styles.populartitle, {color: '#1D1F22'}]}>
                  $ 53.00
                </Text>
              </View>
              <View>
